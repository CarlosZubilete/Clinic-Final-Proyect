<%@ Page Title="" Language="C#" MasterPageFile="~/Clinica.Master" AutoEventWireup="true" CodeBehind="AddPerson.aspx.cs" Inherits="Views.AddPerson" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div>
    ...
    <%-- BUTTON SEND TEST.--%>
    <asp:Button runat="server" Text="AddMedico(Test).aspx" ID="Button1" OnClick="btnSendTest_Click" ValidationGroup="test" />
...
<%-- 
  TODO: When we can add a peson, show a message.
--%>